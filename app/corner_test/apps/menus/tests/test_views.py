...
from corner_test.apps.menus.tests.factories import DishFactory, MenuFactory,\
...
from corner_test.apps.menus.serializers import OrderSerializer,\
    MenuListSerializer, DishSerializer, MenuCreateUpdateSerializer,\
...
from corner_test.apps.utils.tests.test_services import mocked_slack_channel,\
...
class TestLoginView(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(username='foo2',
                                             email='user@foo.com',
                                             password='pass')
    ...
    def test_login_credentials_ok(self):
        ...
        resp = self.client.post(verification_url, {'token': token},
                                format='json')
    ...
    def test_user_not_active_account_credentials(self):
        user = User.objects.create_user(username='foo4',
                                        email='user@foo.com',
                                        password='pass',
                                        is_active=False)
