...
from corner_test.apps.menus.views import OrderListViewSet,\
    MenuCreateUpdateDeleteViewSet, DishListUpdateCreateDeleteViewSet,\
    MenuListAPIView
from corner_test.apps.utils.views import DailyMenuReminderNotificationAPIView, OrderSlackReadAPIView
...
urlpatterns = [
    ...
    path('send_menu_reminder/', DailyMenuReminderNotificationAPIView.as_view(), name="send_reminder"),
